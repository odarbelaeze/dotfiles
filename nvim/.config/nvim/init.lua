...
-- Escape keymaps
vim.keymap.set('i', 'jj', '<Esc>', { desc = 'Send escape from insert mode' })
vim.keymap.set('i', 'kk', '<Esc>', { desc = 'Send escape from insert mode' })

-- Save and exit keymaps
vim.keymap.set('n', '<leader>w', ':w<Cr>', { desc = 'Save current buffer' })
vim.keymap.set('n', '<leader>x', ':x<Cr>', { desc = 'Save and exit current buffer' })
...
require('lazy').setup {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ls', require('telescope.builtin').lsp_document_symbols, '[L]SP: Document symbols')
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        -- Use ruff if available, otherwise use isort and black
        python = function(buffnr)
          if require('conform').get_formatter_info('ruff_format', buffnr).available then
            return { 'ruff_format' }
          end
          -- Conform will use both formatters in sequence
          return { 'isort', 'black' }
        end,
...

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>nt', ':Neotree reveal<Cr>', { desc = 'Open [n]eo[t]ree' })
    end,
  },

  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tf', ':TestFile<Cr>', { desc = 'Run [t]est this [f]ile' })
      vim.keymap.set('n', '<leader>ts', ':TestSuite<Cr>', { desc = 'Run [t]est this [s]uite' })
