...
MY_MAIN_MENU = awful.menu({ items = { { "awesome", MY_AWESOME_MENU, beautiful.awesome_icon },
...
GLOBAL_KEYS = gears.table.join(
    ...
    awful.key({ MODKEY, "Control" }, "w", function () MY_MAIN_MENU:show() end,
...
for i, _tag in ipairs(TAGS) do
    GLOBAL_KEYS = gears.table.join(GLOBAL_KEYS,
        ...
        awful.key({ MODKEY, "Shift" }, _tag,
                  ...
                  {description = "toggle tag " .. _tag, group = "tag"}),
        -- Move client to tag.
